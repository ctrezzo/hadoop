...
public interface MRJobConfig {
  ...
  /**
   * This parameter controls the visibility of the localized job jar on the
   * node manager. If set to true, the visibility will be set to
   * LocalResourceVisibility.PUBLIC. If set to false, the visibility will be
   * set to LocalResourceVisibility.APPLICATION. This is a generated parameter
   * and should not be set manually via config files.
   */
